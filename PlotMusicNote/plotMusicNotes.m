    ...
    methods
        ...
        function plotG_clefs(obj)
            ...
            function drawStaff(start_y)
                ...
                % I need to change the color of the note bc at first it's be yellow
            ...
            % Draw the staff (In 1 page I set up 5 line per page)
            drawStaff(0);
        ...
        function plotNote(obj, note_key, start_measure, duration, staff_index)
            ...
            note_image_file = ['C:\Users\Pooncharat Wongkom\Desktop\MusicNote\MusicNote Symbols\' note_key '.png'];
...
%obj.plotG_clefs(); 
%hold on; 
%obj.plotNote('SixteenthNote', 1, 1, 1); 
%obj.plotNote('HalfNote', 2, 1, 2); 
%hold off;